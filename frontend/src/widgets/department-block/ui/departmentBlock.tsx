...
export const DepartmentBlock = (props: DepartmentBlockProps) => {
    ...
    return <>
        <motion.div 
            ...
            <div className="department-block--heading">
                <h2 className="department-block--heading__title">{props.department.departmentName}</h2>
                <div className="department-block--actions">
                    <div className="department-block--actions__edit" onClick={() => setIsEditModalOpen(true)}>
                    ...
                    <div className="department-block--actions__delete" onClick={() => setIsDeleteModalOpen(true)}>
            ...
            {isDeleteModalOpen
                && <BaseModal onClose={() => setIsDeleteModalOpen(false)}>
                    <div className="department-delete">
                        <h3 className="department-delete--title">{props.department.departmentName}</h3>
